...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
        ...
        public float TimeStopMoveSpeed = 30f;
        private float TimeStopMoveSpeedOffset;
        ...
        [Tooltip("Punch power")] public int PunchPower = 10;
		...
		private void Start()
        {
            TimeStopMoveSpeedOffset = TimeStopMoveSpeed - MoveSpeed;
            ...
            _armsAnimator = GetComponentInChildren<Animator>();
        }
        ...
        public void Punch()
        {
            ...
            if (Physics.Raycast(hitRay, out var raycastHit, 5f, LayerMask.GetMask("Default")))
            {
                if (raycastHit.collider.gameObject.TryGetComponent<Rigidbody>(out var hitRb))
                {
                    Debug.Log("Hit rigidbody!");
                    hitRb.AddForce(hitRay.direction * PunchPower, ForceMode.Impulse);
                    Debug.DrawRay(raycastHit.point, hitRay.direction * PunchPower, Color.red, 5f);
                }
            }
		}
